...
<div class="mb-4">
    <a href="{{ route('tasks.index') }}" class="font-medium text-gray-700">
        ← Back to task list</a
    >
    <span>&nbsp;|&nbsp;</span>
    <a
...
<p class="mb-4">
    @if($task->completed)
    <span class="font-medium text-green-500">completed</span> @else
    <span class="font-medium text-red-500">Not completed</span> @endif
</p>
